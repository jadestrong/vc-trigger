...
var _vueRef = _interopRequireDefault(require("vue-ref"));

var _vueTypes = _interopRequireDefault(require("vc-util-collection/lib/vue-types"));

var _contains = _interopRequireDefault(require("vc-util-collection/lib/Dom/contains"));

var _propsUtil = require("vc-util-collection/lib/props-util");

var _requestAnimationTimeout = require("vc-util-collection/lib/requestAnimationTimeout");

var _addEventListener = _interopRequireDefault(require("vc-util-collection/lib/Dom/addEventListener"));

var _warning = _interopRequireDefault(require("vc-util-collection/lib/warning"));
...
var _vnode = require("vc-util-collection/lib/vnode");

var _ContainerRender = _interopRequireDefault(require("vc-util-collection/lib/ContainerRender"));

_vue["default"].use(_vueRef["default"], {
  name: 'ant-ref'
});
...
var _default2 = {
  ...
  props: {
    ...
    destroyPopupOnHide: _vueTypes["default"].bool.def(false),
    mask: _vueTypes["default"].bool.def(false),
    maskClosable: _vueTypes["default"].bool.def(true),
    // onPopupAlign: PropTypes.func.def(noop),
    popupAlign: _vueTypes["default"].object.def({}),
    popupVisible: _vueTypes["default"].bool,
    defaultPopupVisible: _vueTypes["default"].bool.def(false),
    ...
    alignPoint: _vueTypes["default"].bool // Maybe we can support user pass position in the future
  ...
  methods: {
    ...
    getComponent: function getComponent() {
      ...
      return h(_Popup["default"], (0, _babelHelperVueJsxMergeProps["default"])([{}, popupProps]), [(0, _propsUtil.getComponentFromProp)(self, 'popup')]);
    },
  ...
  render: function render() {
    ...
    if (children.length > 1) {
      (0, _warning["default"])(false, 'Trigger $slots.default.length > 1, just support only one default', true);
    }
    ...
    return h(_ContainerRender["default"], {
      "attrs": {
        "parent": this,
        "visible": sPopupVisible,
        "autoMount": false,
